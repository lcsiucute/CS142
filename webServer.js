...
mongoose.connect('mongodb+srv://linhcot:linhcot20031@cluster0.wkwyjo8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', { useNewUrlParser: true, useUnifiedTopology: true });
...
app.get('/photosOfUser/:id', hasSessionRecord, function (request, response) {
    ...
    Photo.find({user_id: id}, (err, photos) => {
        if (err) {
            ...
            console.log(`** Server: found /photosOfUser/${id} Success! **`);
